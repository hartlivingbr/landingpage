...
-- ────────────────────────────────────────────────────────────────
-- 3. TRIGGER OAuth — REMOVIDO INTENCIONALMENTE
-- ────────────────────────────────────────────────────────────────
-- MOTIVO: O trigger anterior criava TODOS os usuários Google como
-- "proprietario", independente de terem feito login na área de
-- vendedor ou proprietário. Isso impedia vendedores de usar Google.
--
-- SOLUÇÃO: A criação do perfil é feita pelo frontend (dashboard-
-- proprietario.html e dashboard-vendedor.html) após o OAuth,
-- usando o tipo correto de acordo com a página de origem.
-- O sessionStorage registra o tipo antes do redirect OAuth.
-- ────────────────────────────────────────────────────────────────

-- Remove o trigger e função legados caso existam
