...
function LoginForm() {
  ...
  useEffect(() => {
    ...
    // Se já tem sessão + perfil vendedor → dashboard
  ...
  async function entrar() {
    ...
    // Tenta criar perfil a partir dos metadados do cadastro
    ...
    setLoading(false)
    setMsg({ text: 'Você não tem conta de vendedor. Crie uma conta abaixo.', type: 'e' })
  }
    ...
    <div className={styles.body}>
      ...
      <div className={styles.LP}>
        ...
        <div className={styles.FC}>
          ...
          <p className={styles.sub}>Entre no dashboard para acompanhar suas indicações e comissões</p>
          ...
          <p className={styles.prm}>
            Não tem conta? <a href="/cadastro">Criar conta de vendedor</a>
          </p>
        </div>
      </div>
